...
export default function PostPage() {
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			...
			if (file) {
				...
				}/storage/v1/object/public/post_files/public/${uniqueFileName}?t=${encodeURIComponent(
					timestamp
				)}`;
	...
	return (
		<>
			...
			<main className="w-full pb-24">
				<div className="w-full">
					...
					<div className="w-full max-w-5xl mx-auto pt-2 pb-10 px-5 mt-5">
						<div className="w-full">
							<div className="w-full max-w-3xl mx-auto mb-10 px-5 text-center text-lg font-bold text-teal-400">
							...
							<form onSubmit={handleSubmit}>
								...
								<div className="bg-amber-50 p-5 rounded-lg">
									...
									{filePreview && (
										<div className="mt-4">
											<p className="text-sm font-bold text-black text-left mb-2">
												プレビュー:
											</p>
											<Image
												src={filePreview}
			...
			{/* フッター */}
			<footer className="w-full bg-neutral-50 fixed bottom-0 ${styles.footer}">
